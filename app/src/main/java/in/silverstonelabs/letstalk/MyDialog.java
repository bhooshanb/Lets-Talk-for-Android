...
public class MyDialog extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (activePackage.contentEquals(launcherPackage)||activePackage.contentEquals("in.silverstonelabs.letstalk")) {
                    shareText(results.get(position));
                } else {
    ...
    public void getNewPackages() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            try {
                ...
                newPackageName = processInfos.get(0).processName;
            }
        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == check && resultCode == RESULT_OK) {
            ...
            if (launcherPackage.contentEquals(newPackageName) || newPackageName.contentEquals("in.silverstonelabs.letstalk")) {
                tv.setText("One-Touch to Share the Text");
            } else {
                tv.setText("One-Touch to Send Text to " + applicationName + ", Long Press for More.");
            }
